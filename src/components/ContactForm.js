        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              {/* WhatsApp Card */}
              <div className="glass p-5 border border-glass-border flex items-center gap-4 hover:border-emerald-500/30 transition-all duration-300 group">
                <div className="w-10 h-10 rounded-xl bg-emerald-500/5 border border-emerald-500/15 flex items-center justify-center text-emerald-400 group-hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  <div className="font-mono text-[9px] text-muted/60 tracking-wider uppercase">WhatsApp</div>
                  <a
                    href="https://wa.me/8801600690954?text=Hi%20Atikur,%20I'm%20interested%20in%20your%20services!"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm font-semibold text-text hover:text-emerald-400 transition-colors"
                  >
                    +880 1600-690954
                  </a>
                </div>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="flex gap-4">
                {[
                  ...
                  { label: "Facebook", icon: "f", href: "https://www.facebook.com/atikur.rahman.235972" },
                ].map((social) => (
